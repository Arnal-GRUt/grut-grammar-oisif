...
C'est quoi donc ce truc ? Malheureusement la bête à clamsé en 2024, mais depuis les années 2010, c'était un super outil d'aide à la création graphique. Il était mis à disposition des professionnels francophones des métiers d'artistes, par les créateurs du hub coopératif [Café Salé](https://fr.wikipedia.org/wiki/Caf%C3%A9_sal%C3%A9) sur leur site. Il permettait de générer (bien avant ChatGPT) des thèmes aléatoires variés et originaux.  
